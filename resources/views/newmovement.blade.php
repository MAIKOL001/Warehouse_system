...
<section id="content">
    ...
    <main>
        ...
        <H1 style="position:relative;
               ...
               bottom:1rem;
               color:#10405b">
        <i class="fa-solid fa-pen-to-square"></i>Movement Form
    </H1>
 ...
 <form class="form_container ">
  ...
  <div class="input_container">
    <label class="input_label" for="movement_type">Movement Type:</label>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="input_container">
        <label class="input_label" for="total_quantity">To:</label>
        <input placeholder="" title="Input title" name="input-name" type="text" class="input_field" id="to">
      </div>
    </div>
    <div class="col-md-6">
      <div class="input_container">
        <label class="input_label" for="lotno">Quantity:</label>
        <input placeholder="" title="Input title" name="quantity" type="number" class="input_field" id="quantity">
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="input_container">
        <label class="input_label" for="product">Product:</label>
         <select class="input_field" id="product" style="background: white;">
      <option value="" disabled selected hidden></option>
      <option value="option1">Option 1</option>
      <option value="option2">Option 2</option>
      <option value="option3">Option 3</option>
    ...
    <div class="col-md-6">
      <div class="input_container">
        <label class="input_label" for="date">Moving Date:</label>

        ...
        $(document).ready(function () {
            ...
            $("#grid").kendoGrid({
                ...
                columns: [ {
                    ...
                    field: "Total quantities received",
                    title: "Total quantities received",
                    // template: "<input id='rating_#=ProductID#' data-bind='value: CustomerRating' class='rating'/>",
                    editable: returnFalse,
                    width: 140
                }, {
                    field: "Total Quantity Passed ",
                    title: "Total Quantity Passed ",
                    ...
                    field: "Total Quantity Fail ",
                    title: "Total Quantity Fail ",
                    width: 105
                },  {
                    field: "Total SKUs Received",
                    title: "Total SKUs Received",
                    // format: "{0:c}",

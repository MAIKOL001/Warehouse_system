...
<body class="antialiased">
    ...
    <div class="row">
        ...
        <div class="sm-4 px-4">
            <h3>I N V E N T O R Y - M A N A G E M E N T</h3>
        </div>
        <br>
        <p class="content">
        ...
        <img src="/boxleoimages/Isometric_warehouse_and_logistics_auto_x2-removebg-preview.png" alt="My Image" class="image">
        <div class="sm-4 px-4">
